...
export GITHUB_BASE_URL=${GITHUB_BASE_URL:-"https://raw.githubusercontent.com/steeldevlol/pterodactyl-installer"}
...
update_lib_source() {
  ...
  rm -rf /tmp/lib.sh
  curl -sSL -o /tmp/lib.sh "$GITHUB_URL"/master/lib/lib.sh
